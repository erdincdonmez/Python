...
def tabloOlustur():
    secilenvt.execute("CREATE TABLE IF NOT EXISTS ogrenciler(ad TEXT, sinif, tel TEXT, tarih TEXT, saat REAL) ")
    veriTabani.commit()
...
def cokluEkleme():
    komut = 'INSERT INTO ogrenciler(ad, tel) VALUES (?, ?)'
    veriler = [
