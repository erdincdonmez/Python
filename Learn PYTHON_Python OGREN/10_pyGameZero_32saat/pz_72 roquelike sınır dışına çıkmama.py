...
def on_key_down(key):
    if keyboard.right and karakter.x + hucre.width < WIDTH:
        karakter.x += hucre.width
        karakter.image = 'karakter'
    elif keyboard.left and karakter.x - hucre.width > 0:
        hucre.x -= hucre.width
        hucre.image = 'sol'
    elif keyboard.down and hucre.y + hucre.height < HEIGHT :
        hucre.y += hucre.height
    elif keyboard.up and karakter.y - karakter.height > 0:
