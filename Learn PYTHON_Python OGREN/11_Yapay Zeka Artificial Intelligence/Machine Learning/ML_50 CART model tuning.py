# CART ile sınıflandırma problemlerinde Model ve tahmin
...
#! MODEL TUNİNG
denenecek_parametreler = {"max_depth":[1,3,5,8,10],
                          "min_samples_split":[2,3,5,10,20,50]}

cart = DecisionTreeClassifier()
cart_cv_model = GridSearchCV(cart, denenecek_parametreler, cv=10, n_jobs=-1, verbose=2).fit(X_train, y_train)
