# KNN K-Nearest Neighbors / K En yakın komşuimport numpy as np; import pandas as pd
...
#! intercept ve coef doğrusal modellerde olur. knn doğrusal model değildir.
# print("\n\nknn_model.intercept_ : ",knn_model.intercept_)
# print("\n\nknn_model.coef_ :\n ",knn_model.coef_)
...
knn_tuning_parametreleri = {"n_neighbors":np.arange(1,50)}
knn_cv_model = GridSearchCV(knn, knn_tuning_parametreleri, cv=10).fit(X_train, y_train)
