...
grammar = "NP: {<DT>?<JJ>*<NN>}" # regex kuralı belirle
# İsteğe bağlı ( ?) belirleyiciyle ( 'DT') başlayın
# *Herhangi bir sayıda ( ) sıfat ( JJ) bulunabilir
# Bir isimle bitirin ( <NN>)

# yığın ayrıştırıcı oluşturun
