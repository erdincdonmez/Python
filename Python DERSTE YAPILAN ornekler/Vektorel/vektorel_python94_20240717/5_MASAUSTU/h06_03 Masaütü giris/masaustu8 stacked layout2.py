...
class AnaPencere(QWidget): # !!! QWidget olmasına dikkat et !!!
    ...
    def __init__(self):
        ...
        self.Dugme_yatay_icerik = QHBoxLayout()
        self.buton1 = QPushButton('Öğrenciler')
        self.Dugme_yatay_icerik.addWidget(self.buton1)
        self.buton2 = QPushButton('Öğretmenler')
        self.Dugme_yatay_icerik.addWidget(self.buton2)
        self.buton3 = QPushButton('Ayarlar')
        self.Dugme_yatay_icerik.addWidget(self.buton3)
        ...
        anaYerlesim.addLayout(self.Dugme_yatay_icerik)
        anaYerlesim.addLayout(self.stackedSekmeler)
        self.stackedSekmeler.setCurrentIndex(2)
